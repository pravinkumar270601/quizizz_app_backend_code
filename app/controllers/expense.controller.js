...
exports.getExpenseDetails = async (req, res) => {
  try {
    const query = `
    SELECT e.expense_id,m.movie_name,s.location,sch.date_of_shooting,c.crew_name,cat.category_name,e.no_of_staffs,e.advance_amount,e.beta FROM expensetracker_t_expense_t as e 
