...
const studentAnswersController = require("../controllers/student_answer.controller.js");
...
router.get(
  "/getPublishByStudentId/student/:student_id",
  publishController.getPublishByStudentId
);

router.post(
  "/grantAccessToMultiStudent",
  publishController.grantAccessToMultiStudent
);
router.post(
  "/revokeAccessToMultiStudent",
  publishController.revokeAccessToMultiStudent
);
...
router.get(
  "/getStudentsWithAccessByPublishId/publish/:publish_id",
  studentController.getStudentsWithAccessByPublishId
);
router.get(
  "/getAccessGrantedStudentsInfoBypublishId/publish/:publish_id",
  studentController.getAccessGrantedStudentsInfo
);
...
router.get(
  "/getAllPublishesWithStudentScore/student/:student_id",
  studentDasbordController.getAllPublishesWithStudentScore
);
router.get(
  "/getStudentReportsForStaff/student/:student_id/staff/:staff_id",
  studentDasbordController.getStudentReportsForStaff
);

// student answer

router.post("/studentAnswersPost", studentAnswersController.storeStudentAnswer);

router.get(
  "/attempts/student/:student_id/publish/:publish_id",
  studentAnswersController.getAttemptsWithAnswers
);
